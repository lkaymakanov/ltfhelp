...
public class TranspmeansReg  extends ToJsonBase{
	
	{
		addProperty(new Property<LongToJsonWrapper>(null, "transpmeansreg_id"));
		addProperty(new Property<StringToJsonWrapper>(null, "code"));
		addProperty(new Property<StringToJsonWrapper>(null, "name"));
		addProperty(new Property<StringToJsonWrapper>(null, "type"));
	}
